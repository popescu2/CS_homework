...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1209 = freeFrame * 8192		(int)
	load	[r14+-52],r1
	mov	8192,r2
	mul	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-20]
!   frameAddr = 1048576 + _temp_1209		(int)
	set	1048576,r1
	load	[r14+-20],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (aPageTable) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1210 = aPageTable + 4
	load	[r14+12],r1
	add	r1,4,r1
	store	r1,[r14+-16]
!   Data Move: *_temp_1210 = numFramesNeeded  (sizeInBytes=4)
	load	[r14+16],r1
	load	[r14+-16],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (aPageTable) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1229 = aPageTable + 4
	load	[r14+12],r1
	add	r1,4,r1
	store	r1,[r14+-40]
!   Data Move: numReturn = *_temp_1229  (sizeInBytes=4)
	load	[r14+-40],r1
	load	[r1],r1
	store	r1,[r14+-60]
! FOR STATEMENT...
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1236 = addr - 1048576		(int)
	load	[r14+-52],r1
	set	1048576,r2
	sub	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-28]
!   bitNumber = _temp_1236 div 8192		(int)
	load	[r14+-28],r1
	mov	8192,r2
	cmp	r2,0
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1259 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-108]
!   NEW ARRAY Constructor...
!   _temp_1261 = &_temp_1260
	add	r14,-104,r1
	store	r1,[r14+-20]
!   _temp_1261 = _temp_1261 + 4
	load	[r14+-20],r1
	add	r1,4,r1
	store	r1,[r14+-20]
!   Next value...
	...
	store	r1,[r14+-16]
_Label_1263:
!   Data Move: *_temp_1261 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-20],r2
	store	r1,[r2]
!   _temp_1261 = _temp_1261 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-20]
!   _temp_1262 = _temp_1262 + -1
	load	[r14+-16],r1
	add	r1,-1,r1
	store	r1,[r14+-16]
!   if intNotZero (_temp_1262) then goto _Label_1263
	load	[r14+-16],r1
	cmp	r1,r0
	bne	_Label_1263
!   Initialize the array size...
...
!   make sure array has size 20
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_1259 = *_temp_1264  (sizeInBytes=84)
	load	[r14+-12],r5
	load	[r14+-108],r4
	mov	21,r3
_Label_1782:
...
! FOR STATEMENT...
	...
	mov	"\0\0FO",r10
!   Calculate and save the FOR-LOOP starting value
!   _temp_1278 = 0		(4 bytes)
	mov	0,r1
	store	r1,[r14+-156]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1279 = numberOfPages - 1		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	1,r2
	sub	r1,r2,r1
	...
	store	r1,[r14+-152]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_1278  (sizeInBytes=4)
	load	[r14+-156],r1
	store	r1,[r14+-168]
_Label_1274:
!   Perform the FOR-LOOP termination test
!   if i > _temp_1279 then goto _Label_1277		
	load	[r14+-168],r1
	load	[r14+-152],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_1286 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-124]
!   Move address of _temp_1286 [i ] into _temp_1287
!     make sure index expr is >= 0
	load	[r14+-168],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1291  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-104]
...
!   Send message ExtractUndefinedBits
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_1296  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-92]
!   if intIsZero (_temp_1296) then goto _Label_1295
	load	[r14+-92],r1
	cmp	r1,r0
	be	_Label_1295
!	jmp	_Label_1294
...
!   Send message IsDirty
	...
	add	r2,24,r2
	call	r2
!   if result==true then goto _Label_1303 else goto _Label_1304
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1304
	jmp	_Label_1303
...
!   Send message IsReferenced
	...
	add	r2,28,r2
	call	r2
!   if result==true then goto _Label_1310 else goto _Label_1311
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1311
	jmp	_Label_1310
...
! RETURN STATEMENT...
	...
	mov	"\0\0RE",r10
!   _temp_1374 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1374 [entry ] into _temp_1375
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_1373 = *_temp_1375  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1372 = _temp_1373 AND -8192		(int)
	load	[r14+-20],r1
	mov	-8192,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1372  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
! RETURN STATEMENT...
	...
	mov	"\0\0RE",r10
!   _temp_1385 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1385 [entry ] into _temp_1386
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_1384 = *_temp_1386  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1383 = _temp_1384 AND 8176		(int)
	load	[r14+-20],r1
	mov	8176,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1383  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
!   _temp_1394 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-36]
!   Move address of _temp_1394 [entry ] into _temp_1395
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1398 = *_temp_1400  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1397 = _temp_1398 AND 8191		(int)
	load	[r14+-20],r1
	mov	8191,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   _temp_1396 = _temp_1397 OR frameAddr		(int)
	load	[r14+-24],r1
	load	[r14+16],r2
	or	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1414 = *_temp_1416  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1413 = _temp_1414 AND 8		(int)
	load	[r14+-24],r1
	mov	8,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1429 = *_temp_1431  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1428 = _temp_1429 AND 4		(int)
	load	[r14+-24],r1
	mov	4,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1444 = *_temp_1446  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1443 = _temp_1444 AND 2		(int)
	load	[r14+-24],r1
	mov	2,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1459 = *_temp_1461  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1458 = _temp_1459 AND 1		(int)
	load	[r14+-24],r1
	mov	1,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1458) then goto _Label_1462
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1462
!   _temp_1457 = 1		(1 byte)
...
!   _temp_1457 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1463:
!   ReturnResult: _temp_1457  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1475 = *_temp_1477  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1474 = _temp_1475 OR 8		(int)
	load	[r14+-20],r1
	mov	8,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1490 = *_temp_1492  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1489 = _temp_1490 OR 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1505 = *_temp_1507  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1504 = _temp_1505 OR 2		(int)
	load	[r14+-20],r1
	mov	2,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1520 = *_temp_1522  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1519 = _temp_1520 OR 1		(int)
	load	[r14+-20],r1
	mov	1,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1535 = *_temp_1537  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1534 = _temp_1535 AND -9		(int)
	load	[r14+-20],r1
	mov	-9,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1550 = *_temp_1552  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1549 = _temp_1550 AND -5		(int)
	load	[r14+-20],r1
	mov	-5,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1565 = *_temp_1567  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1564 = _temp_1565 AND -3		(int)
	load	[r14+-20],r1
	mov	-3,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1580 = *_temp_1582  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1579 = _temp_1580 AND -2		(int)
	load	[r14+-20],r1
	mov	-2,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   _temp_1593 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-20]
!   Move address of _temp_1593 [0 ] into _temp_1594
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   _temp_1592 = _temp_1594		(4 bytes)
	load	[r14+-16],r1
	store	r1,[r14+-24]
!   _temp_1595 = numberOfPages * 4		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	4,r2
	mul	r1,r2,r1
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1602
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1602
	jmp	_Label_1603
...
! IF STATEMENT...
	mov	1358,r13		! source line 1358
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1606		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1618  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   fromAddr = _temp_1618 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-44],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1620:
!   if offset >= 8192 then goto _Label_1622		(int)
	load	[r14+-44],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (fromAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1623 = *fromAddr  (sizeInBytes=1)
	load	[r14+-48],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *kernelAddr = _temp_1623  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+12],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1625		(int)
	load	[r14+-36],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1625
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1642
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1642
	jmp	_Label_1643
...
! IF STATEMENT...
	mov	1408,r13		! source line 1408
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1646		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   Retrieve Result: targetName=_temp_1654  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-11]
!   if _temp_1654 then goto _Label_1652 else goto _Label_1650
	loadb	[r14+-11],r1
	cmp	r1,0
	be	_Label_1650
	jmp	_Label_1652
...
!   Retrieve Result: targetName=_temp_1656  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   if _temp_1656 then goto _Label_1651 else goto _Label_1650
	loadb	[r14+-10],r1
	cmp	r1,0
	be	_Label_1650
	jmp	_Label_1651
...
!   Retrieve Result: targetName=_temp_1658  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   destAddr = _temp_1658 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-40],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1660:
!   if offset >= 8192 then goto _Label_1662		(int)
	load	[r14+-40],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (kernelAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1663 = *kernelAddr  (sizeInBytes=1)
	load	[r14+16],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *destAddr = _temp_1663  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+-44],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1665		(int)
	load	[r14+-32],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1665
...
!   Retrieve Result: targetName=_temp_1684  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-40]
!   if _temp_1684 >= 4 then goto _Label_1683		(int)
	load	[r14+-40],r1
	mov	4,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if sourceSize <= maxSize then goto _Label_1688		(int)
	load	[r14+-44],r1
	load	[r14+20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! RETURN STATEMENT...
	...
	mov	1474,r13		! source line 1474
	mov	"\0\0SE",r10
!   _temp_1691 = kernelAddr		(4 bytes)
	load	[r14+12],r1
	store	r1,[r14+-20]
!   _temp_1690 = _temp_1691 + 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   _temp_1692 = virtAddr + 4		(int)
	load	[r14+16],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
!   Retrieve Result: targetName=_temp_1689  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-28]
!   ReturnResult: _temp_1689  (sizeInBytes=4)
	load	[r14+-28],r1
	store	r1,[r14+8]
	add	r15,56,r15
	pop	r13
