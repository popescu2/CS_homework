...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_991 = _function_125_PrintObjectAddr
	set	_function_125_PrintObjectAddr,r1
	store	r1,[r14+-16]
!   _temp_992 = &freeList
	load	[r14+8],r1
...
! FOR STATEMENT...
	...
	mov	"\0\0FO",r10
!   Calculate and save the FOR-LOOP starting value
!   _temp_1012 = 0		(4 bytes)
	mov	0,r1
	store	r1,[r14+-40]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1013 = 9		(4 bytes)
	mov	9,r1
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_1012  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-48]
_Label_1008:
!   Perform the FOR-LOOP termination test
!   if i > _temp_1013 then goto _Label_1011		
	load	[r14+-48],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_1018 = _function_125_PrintObjectAddr
	set	_function_125_PrintObjectAddr,r1
	store	r1,[r14+-16]
!   _temp_1019 = &freeList
	load	[r14+8],r1
...
! FOR STATEMENT...
	...
	mov	"\0\0FO",r10
!   Calculate and save the FOR-LOOP starting value
!   _temp_1051 = 1048576		(4 bytes)
	set	1048576,r1
	store	r1,[r14+-24]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1052 = 1048876		(4 bytes)
	set	1048876,r1
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_1051  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-56]
_Label_1047:
!   Perform the FOR-LOOP termination test
!   if i > _temp_1052 then goto _Label_1050		
	load	[r14+-56],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (i) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1055 = *i  (sizeInBytes=4)
	load	[r14+-56],r1
	load	[r1],r1
	store	r1,[r14+-16]
!   if intIsZero (_temp_1055) then goto _Label_1054
	load	[r14+-16],r1
	cmp	r1,r0
	be	_Label_1054
!	jmp	_Label_1053
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1086:
!   if numberFreeFrames >= 1 then goto _Label_1088		(int)
	load	[r14+8],r1
	load	[r1+16],r1
	mov	1,r2
	cmp	r1,r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_1089 = &frameManagerLock
	load	[r14+8],r1
	add	r1,20,r1
	store	r1,[r14+-28]
!   _temp_1090 = &newFramesAvailable
	load	[r14+8],r1
	add	r1,40,r1
	store	r1,[r14+-24]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1093 = f * 8192		(int)
	load	[r14+-36],r1
	mov	8192,r2
	mul	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-12]
!   frameAddr = 1048576 + _temp_1093		(int)
	set	1048576,r1
	load	[r14+-12],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1113 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-108]
!   NEW ARRAY Constructor...
!   _temp_1115 = &_temp_1114
	add	r14,-104,r1
	store	r1,[r14+-20]
!   _temp_1115 = _temp_1115 + 4
	load	[r14+-20],r1
	add	r1,4,r1
	store	r1,[r14+-20]
!   Next value...
...
!   _temp_1115 = _temp_1115 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-20]
!   _temp_1116 = _temp_1116 + -1
	load	[r14+-16],r1
	add	r1,-1,r1
	store	r1,[r14+-16]
!   if intNotZero (_temp_1116) then goto _Label_1117
	load	[r14+-16],r1
	cmp	r1,r0
	bne	_Label_1117
!   Initialize the array size...
...
!   make sure array has size 20
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_1113 = *_temp_1118  (sizeInBytes=84)
	load	[r14+-12],r5
	load	[r14+-108],r4
	mov	21,r3
_Label_1627:
...
!   _temp_1132 = 0		(4 bytes)
	...
	store	r1,[r14+-156]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1133 = numberOfPages - 1		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	1,r2
	sub	r1,r2,r1
...
! CALL STATEMENT...
	...
	load	[r14+8],r1
	store	r1,[r14+-100]
!   if intIsZero (_temp_1146) then goto _runtimeErrorNullPointer
	load	[r14+-100],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1145  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-104]
...
!   Send message ExtractUndefinedBits
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_1150  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-92]
...
! CALL STATEMENT...
	...
	load	[r14+8],r1
	store	r1,[r14+-80]
!   if intIsZero (_temp_1153) then goto _runtimeErrorNullPointer
	load	[r14+-80],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=i  sizeInBytes=4
...
!   Send message ExtractUndefinedBits
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_1152  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-84]
...
! IF STATEMENT...
	...
	load	[r14+8],r1
	store	r1,[r14+-68]
!   if intIsZero (_temp_1159) then goto _runtimeErrorNullPointer
	load	[r14+-68],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=i  sizeInBytes=4
...
!   Send message IsDirty
	...
	add	r2,24,r2
	call	r2
!   if result==true then goto _Label_1157 else goto _Label_1158
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1158
	jmp	_Label_1157
...
!   Send message IsReferenced
	...
	add	r2,28,r2
	call	r2
!   if result==true then goto _Label_1164 else goto _Label_1165
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1165
	jmp	_Label_1164
...
!   Send message IsWritable
	...
	add	r2,32,r2
	call	r2
!   if result==true then goto _Label_1171 else goto _Label_1172
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1172
	jmp	_Label_1171
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   if result==true then goto _Label_1178 else goto _Label_1179
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1179
	jmp	_Label_1178
...
!   _temp_1228 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1228 [entry ] into _temp_1229
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1227 = *_temp_1229  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1226 = _temp_1227 AND -8192		(int)
	load	[r14+-20],r1
	mov	-8192,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1226  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
! RETURN STATEMENT...
	...
	mov	"\0\0RE",r10
!   _temp_1239 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1239 [entry ] into _temp_1240
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1238 = *_temp_1240  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1237 = _temp_1238 AND 8176		(int)
	load	[r14+-20],r1
	mov	8176,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1237  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1248 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-36]
!   Move address of _temp_1248 [entry ] into _temp_1249
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   _temp_1253 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1253 [entry ] into _temp_1254
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1252 = *_temp_1254  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1251 = _temp_1252 AND 8191		(int)
	load	[r14+-20],r1
	mov	8191,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   _temp_1250 = _temp_1251 OR frameAddr		(int)
	load	[r14+-24],r1
	load	[r14+16],r2
	or	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1268 = *_temp_1270  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1267 = _temp_1268 AND 8		(int)
	load	[r14+-24],r1
	mov	8,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1267) then goto _Label_1271
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1271
!   _temp_1266 = 1		(1 byte)
...
!   _temp_1266 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1272:
!   ReturnResult: _temp_1266  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1283 = *_temp_1285  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1282 = _temp_1283 AND 4		(int)
	load	[r14+-24],r1
	mov	4,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1282) then goto _Label_1286
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1286
!   _temp_1281 = 1		(1 byte)
...
!   _temp_1281 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1287:
!   ReturnResult: _temp_1281  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
! RETURN STATEMENT...
	...
	mov	"\0\0RE",r10
!   _temp_1299 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-20]
!   Move address of _temp_1299 [entry ] into _temp_1300
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1298 = *_temp_1300  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1297 = _temp_1298 AND 2		(int)
	load	[r14+-24],r1
	mov	2,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1297) then goto _Label_1301
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1301
!   _temp_1296 = 1		(1 byte)
...
!   _temp_1296 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1302:
!   ReturnResult: _temp_1296  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   _temp_1314 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-20]
!   Move address of _temp_1314 [entry ] into _temp_1315
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   Data Move: _temp_1313 = *_temp_1315  (sizeInBytes=4)
	load	[r14+-16],r1
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1312 = _temp_1313 AND 1		(int)
	load	[r14+-24],r1
	mov	1,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1312) then goto _Label_1316
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1316
!   _temp_1311 = 1		(1 byte)
...
!   _temp_1311 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1317:
!   ReturnResult: _temp_1311  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1329 = *_temp_1331  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1328 = _temp_1329 OR 8		(int)
	load	[r14+-20],r1
	mov	8,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1344 = *_temp_1346  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1343 = _temp_1344 OR 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1359 = *_temp_1361  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1358 = _temp_1359 OR 2		(int)
	load	[r14+-20],r1
	mov	2,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1374 = *_temp_1376  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1373 = _temp_1374 OR 1		(int)
	load	[r14+-20],r1
	mov	1,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1389 = *_temp_1391  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1388 = _temp_1389 AND -9		(int)
	load	[r14+-20],r1
	mov	-9,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1404 = *_temp_1406  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1403 = _temp_1404 AND -5		(int)
	load	[r14+-20],r1
	mov	-5,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   _temp_1420 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1420 [entry ] into _temp_1421
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_1419 = *_temp_1421  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1418 = _temp_1419 AND -3		(int)
	load	[r14+-20],r1
	mov	-3,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   _temp_1435 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1435 [entry ] into _temp_1436
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1434 = *_temp_1436  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1433 = _temp_1434 AND -2		(int)
	load	[r14+-20],r1
	mov	-2,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   _temp_1447 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-20]
!   Move address of _temp_1447 [0 ] into _temp_1448
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   _temp_1446 = _temp_1448		(4 bytes)
	load	[r14+-16],r1
	store	r1,[r14+-24]
!   _temp_1449 = numberOfPages * 4		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	4,r2
	mul	r1,r2,r1
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1456
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1456
	jmp	_Label_1457
...
! IF STATEMENT...
	mov	1277,r13		! source line 1277
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1460		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage < numberOfPages then goto _Label_1465		(int)
	load	[r14+-40],r1
	load	[r14+8],r2
	load	[r2+4],r2
	cmp	r1,r2
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   Retrieve Result: targetName=_temp_1469  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1472  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   fromAddr = _temp_1472 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-44],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1474:
!   if offset >= 8192 then goto _Label_1476		(int)
	load	[r14+-44],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (fromAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1477 = *fromAddr  (sizeInBytes=1)
	load	[r14+-48],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *kernelAddr = _temp_1477  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+12],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1479		(int)
	load	[r14+-36],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1479
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1496
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1496
	jmp	_Label_1497
...
! IF STATEMENT...
	mov	1327,r13		! source line 1327
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1500		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage < numberOfPages then goto _Label_1507		(int)
	load	[r14+-36],r1
	load	[r14+8],r2
	load	[r2+4],r2
	cmp	r1,r2
...
!   Retrieve Result: targetName=_temp_1508  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-11]
!   if _temp_1508 then goto _Label_1506 else goto _Label_1504
	loadb	[r14+-11],r1
	cmp	r1,0
	be	_Label_1504
	jmp	_Label_1506
...
!   Send message IsWritable
	...
	add	r2,32,r2
	call	r2
!   Retrieve Result: targetName=_temp_1510  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   if _temp_1510 then goto _Label_1505 else goto _Label_1504
	loadb	[r14+-10],r1
	cmp	r1,0
	be	_Label_1504
	jmp	_Label_1505
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1512  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   destAddr = _temp_1512 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-40],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1514:
!   if offset >= 8192 then goto _Label_1516		(int)
	load	[r14+-40],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (kernelAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1517 = *kernelAddr  (sizeInBytes=1)
	load	[r14+16],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *destAddr = _temp_1517  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+-44],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1519		(int)
	load	[r14+-32],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1519
...
!   Send message CopyBytesFromVirtual
	...
	add	r2,76,r2
	call	r2
!   Retrieve Result: targetName=_temp_1538  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-40]
!   if _temp_1538 >= 4 then goto _Label_1537		(int)
	load	[r14+-40],r1
	mov	4,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if sourceSize <= maxSize then goto _Label_1542		(int)
	load	[r14+-44],r1
	load	[r14+20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! RETURN STATEMENT...
	...
	mov	1393,r13		! source line 1393
	mov	"\0\0SE",r10
!   _temp_1545 = kernelAddr		(4 bytes)
	load	[r14+12],r1
	store	r1,[r14+-20]
!   _temp_1544 = _temp_1545 + 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   _temp_1546 = virtAddr + 4		(int)
	load	[r14+16],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
!   Prepare Argument: offset=12  value=_temp_1544  sizeInBytes=4
	load	[r14+-24],r1
	store	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_1546  sizeInBytes=4
	load	[r14+-16],r1
	store	r1,[r15+8]
...
!   Send message CopyBytesFromVirtual
	...
	add	r2,76,r2
	call	r2
!   Retrieve Result: targetName=_temp_1543  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-28]
