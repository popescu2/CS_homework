...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_507 = &_Global_m_lock1
	set	_Global_m_lock1,r1
	store	r1,[r14+-164]
!   Send message Init
	load	[r14+-164],r1
	load	[r1],r2
...
_Label_508:
!   Perform the FOR-LOOP termination test
!   if * _temp_512 > _temp_515 then goto _Label_511		
	load	[r14+-160],r1
	load	[r1],r1
	load	[r14+-148],r2
	cmp	r1,r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_516 = &_Global_con
	set	_Global_con,r1
	store	r1,[r14+-144]
!   Move address of _temp_516 [_Global_l ] into _temp_517
!     make sure index expr is >= 0
	set	_Global_l,r2
	load	[r2],r2
	cmp	r2,0
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_523 = _function_45_PhilosphizeAndEat
	set	_function_45_PhilosphizeAndEat,r1
	store	r1,[r14+-116]
!   _temp_524 = &_Global_philospher
	set	_Global_philospher,r1
	store	r1,[r14+-112]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_526 = _StringConst_38
	set	_StringConst_38,r1
	store	r1,[r14+-104]
!   _temp_527 = &_Global_philospher
	set	_Global_philospher,r1
	store	r1,[r14+-100]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_529 = _function_45_PhilosphizeAndEat
	set	_function_45_PhilosphizeAndEat,r1
	store	r1,[r14+-92]
!   _temp_530 = &_Global_philospher
	set	_Global_philospher,r1
	store	r1,[r14+-88]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_535 = _function_45_PhilosphizeAndEat
	set	_function_45_PhilosphizeAndEat,r1
	store	r1,[r14+-68]
!   _temp_536 = &_Global_philospher
	set	_Global_philospher,r1
	store	r1,[r14+-64]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_538 = _StringConst_40
	set	_StringConst_40,r1
	store	r1,[r14+-56]
!   _temp_539 = &_Global_philospher
	set	_Global_philospher,r1
	store	r1,[r14+-52]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_541 = _function_45_PhilosphizeAndEat
	set	_function_45_PhilosphizeAndEat,r1
	store	r1,[r14+-44]
!   _temp_542 = &_Global_philospher
	set	_Global_philospher,r1
	store	r1,[r14+-40]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_544 = _StringConst_41
	set	_StringConst_41,r1
	store	r1,[r14+-32]
!   _temp_545 = &_Global_philospher
	set	_Global_philospher,r1
	store	r1,[r14+-28]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_547 = _function_45_PhilosphizeAndEat
	set	_function_45_PhilosphizeAndEat,r1
	store	r1,[r14+-20]
!   _temp_548 = &_Global_philospher
	set	_Global_philospher,r1
	store	r1,[r14+-16]
...
!   _temp_600 = 7		(4 bytes)
	...
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_599  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-28]
_Label_595:
!   Perform the FOR-LOOP termination test
!   if i > _temp_600 then goto _Label_598		
	load	[r14+-28],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
_P_Main_ForkMonitor:
	...
	jmp	_Method_P_Main_ForkMonitor_5	! 20:	ForksAvailable
	.word	0
! 
! Class descriptor:
! 
...
!   Send message IsHeldByCurrentThread
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_614  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   _temp_616 = _temp_614 XOR 0		(bool)
	loadb	[r14+-10],r1
	mov	0,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_616 then goto _Label_613 else goto _Label_612
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_612
	jmp	_Label_613
...
!   Next value...
	...
	store	r1,[r14+-24]
_Label_622:
!   Data Move: *_temp_620 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-28],r2
	store	r1,[r2]
!   _temp_620 = _temp_620 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   _temp_621 = _temp_621 + -1
	load	[r14+-24],r1
	add	r1,-1,r1
	store	r1,[r14+-24]
!   if intNotZero (_temp_621) then goto _Label_622
	load	[r14+-24],r1
	cmp	r1,r0
	bne	_Label_622
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_618 = *_temp_623  (sizeInBytes=24)
	load	[r14+-20],r5
	load	[r14+-56],r4
	load	[r5],r1
	store	r1,[r4]
...
!   Send message IsHeldByCurrentThread
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_639  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-12]
!   _temp_641 = _temp_639 XOR 0		(bool)
	loadb	[r14+-12],r1
	mov	0,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-11]
!   if _temp_641 then goto _Label_638 else goto _Label_637
	loadb	[r14+-11],r1
	cmp	r1,0
	be	_Label_637
	jmp	_Label_638
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-52]
!   Data Move: *_temp_644 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-52],r2
	store	r1,[r2]
! SEND STATEMENT...
...
_Label_646:
	mov	564,r13		! source line 564
	mov	"\0\0SE",r10
!   _temp_650 = &_Global_mon
	set	_Global_mon,r1
	store	r1,[r14+-44]
!   Prepare Argument: offset=12  value=p  sizeInBytes=4
	load	[r14+12],r1
	store	r1,[r15+4]
!   Send message ForksAvailable
	load	[r14+-44],r1
	load	[r1],r2
	cmp	r2,0
	be	 _runtimeErrorUninitializedObject
	...
	add	r2,20,r2
	call	r2
!   Retrieve Result: targetName=_temp_649  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   _temp_651 = _temp_649 XOR 0		(bool)
	loadb	[r14+-10],r1
	mov	0,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_651 then goto _Label_648 else goto _Label_647
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_647
	jmp	_Label_648
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_652 = &_Global_m_lock1
	set	_Global_m_lock1,r1
	store	r1,[r14+-40]
!   _temp_653 = &_Global_con
	set	_Global_con,r1
	store	r1,[r14+-36]
!   Move address of _temp_653 [p ] into _temp_654
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_655 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_655 [p ] into _temp_656
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: *_temp_656 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-24],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   Retrieve Result: targetName=_temp_681  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   _temp_683 = _temp_681 XOR 0		(bool)
	loadb	[r14+-10],r1
	mov	0,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_683 then goto _Label_680 else goto _Label_679
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_679
	jmp	_Label_680
...
!   _temp_693 = _temp_694 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-88]
!   Move address of _temp_692 [_temp_693 ] into _temp_695
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_691 = *_temp_695  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-96]
!   if _temp_691 == 2 then goto _Label_689		(int)
	load	[r14+-96],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_689
...
!   _temp_698 = _temp_699 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-68]
!   Move address of _temp_697 [_temp_698 ] into _temp_700
!     make sure index expr is >= 0
	load	[r14+-68],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_696 = *_temp_700  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-76]
!   if _temp_696 != 1 then goto _Label_689		(int)
	load	[r14+-76],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_689
...
! SEND STATEMENT...
	mov	587,r13		! source line 587
	mov	"\0\0SE",r10
!   _temp_701 = &_Global_m_lock1
	set	_Global_m_lock1,r1
	store	r1,[r14+-56]
!   _temp_702 = &_Global_con
	set	_Global_con,r1
	store	r1,[r14+-52]
!   _temp_704 = p - 1		(int)
	load	[r14+12],r1
...
!   _temp_703 = _temp_704 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-48]
!   Move address of _temp_702 [_temp_703 ] into _temp_705
!     make sure index expr is >= 0
	load	[r14+-48],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	mov	589,r13		! source line 589
	mov	"\0\0SE",r10
!   _temp_707 = &_Global_m_lock1
	set	_Global_m_lock1,r1
	store	r1,[r14+-36]
!   _temp_708 = &_Global_con
	set	_Global_con,r1
	store	r1,[r14+-32]
!   _temp_710 = p + 1		(int)
	load	[r14+12],r1
...
!   _temp_709 = _temp_710 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-28]
!   Move address of _temp_708 [_temp_709 ] into _temp_711
!     make sure index expr is >= 0
	load	[r14+-28],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_749 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_748  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_744:
!   Perform the FOR-LOOP termination test
!   if p > _temp_749 then goto _Label_747		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_756 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_756 [p ] into _temp_757
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_777 = _temp_778 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-40]
!   Move address of _temp_776 [_temp_777 ] into _temp_779
!     make sure index expr is >= 0
	load	[r14+-40],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_775 = *_temp_779  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-48]
!   if _temp_775 == 2 then goto _Label_773		(int)
	load	[r14+-48],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_773
...
!   Data Move: _temp_780 = *_temp_784  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-28]
!   if _temp_780 == 2 then goto _Label_773		(int)
	load	[r14+-28],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_773
